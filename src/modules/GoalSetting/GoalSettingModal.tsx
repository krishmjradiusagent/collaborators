            ...
            {METRICS.map((metric) => (
              <div key={metric.key} className="space-y-3">
                ...
                <Input
                   ...
                   className="h-12 bg-[#F9FAFB] border-[#E5E7EB] rounded-xl text-[18px] font-bold text-[#111827] focus-visible:ring-primary/20 focus-visible:border-primary transition-all"
